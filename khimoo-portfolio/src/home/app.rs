...
pub fn home() -> Html {
    ...
    let container_pos_handle = use_state(|| Position { x: 0.0, y: 0.0 });
    ...
    html! {
        <div onmousemove={on_mouse_move}>
            ...
            <NodeGraphContainer
                ...
                container_bound={
                    ContainerBound {
                        x: container_measure_handle.x as f32 + container_pos_handle.x,
                        y: container_measure_handle.y as f32 + container_pos_handle.y,
                        width: container_measure_handle.width as f32,
                        height: container_measure_handle.height as f32,
                        top: container_measure_handle.top as f32 + container_pos_handle.y,
                        left: container_measure_handle.left as f32 + container_pos_handle.x,
                        bottom: container_measure_handle.bottom as f32 + container_pos_handle.y,
                        right: container_measure_handle.right as f32 + container_pos_handle.x,
                    }
                }
            />
        </div>
